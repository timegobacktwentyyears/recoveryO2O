...
`user_desc` varchar(256) DEFAULT NULL COMMENT '用户简介',
`user_type` tinyint(1) DEFAULT NULL COMMENT '用户类型：0 社区用户，1 回收员，2 管理员',
`user_area` int(11) DEFAULT NULL COMMENT '用户地址',
...
`user_id`  int(11) NOT NULL  COMMENT '用     户id ',
`gmt_create` datetime NOT NULL  COMMENT '新增时间',
